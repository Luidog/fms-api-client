...
A FileMaker Data API client designed to allow easier interaction with a FileMaker database from a web environment. This client abstracts the FileMaker 17 Data API into class based methods. 
...
- [fms-api-client](#fms-api-client)
  ...
  * [Usage](#usage)
    ...
    + [Client Methods](#client-methods)
      - [Get Product Info](#productinfo)
      - [Get Databases](#databases)
      - [Get Layouts](#layouts)
      - [Get scripts](#scripts)
      - [Get Layout Metadata](#layout)
...
A client can get the databases accessible using the configured credentials the databases method will return all databases hosted by the currently configured server that the client can connect to. 
...
<!--@snippet('./examples/metadata.examples.js#layout-example', { showSource: true })-->
<!--/@-->
Result:
<!--@snippet('./examples/results/layout-example.json', { showSource: true })-->
<!--/@-->
...
Using the client you can duplicate a FileMaker record.
...
<!--@snippet('./examples/script.examples.js#run-scripts-example', { showSource: true })-->
<!--/@-->
Result:
